...
describe Pet, type: :model do
    ...
    it "can get the proper application text and class" do
        shelter_1 = Shelter.create( name:    "4 Paws Rescue",
                            address: "6567 W Long Dr.",
                            city:    "Littleton",
                            state:   "CO",
        ...
        expect(pet_1.application_link_text).to eq("Approve")
        expect(pet_2.application_link_text).to eq("Unapprove")
    end
end