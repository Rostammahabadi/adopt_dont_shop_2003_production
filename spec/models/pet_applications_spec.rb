...
RSpec.describe PetApplication, type: :model do
  ...
  it "can get redirect_paths" do
    ...
    expect(pet_app.redirect_path_start).to eq("pets")
    expect(pet_app2.redirect_path_start).to eq("applications")
    expect(pet_app.redirect_path_end).to eq(pet_1.id)
    expect(pet_app2.redirect_path_end).to eq(application1.id)
  end
end
